...
#### run data - sig counts
#lif.reprocess_binary_data_sig(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACRUISE\C287_020522\LIFCnts_20220502', 
                              #'02/05/2022 08:35:50', skip_start=1, n_bad_online=1)

#### run data - ref counts
#lif.reprocess_binary_data_ref(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACRUISE\C287_020522\LIFCnts_20220502', 
                              #'02/05/2022 08:35:50', skip_start=1, n_bad_online=1)


# Load signal counts
sig_cts_data = lif.load_counts(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACRUISE\C287_020522\processed data_050224_sig')
print(sig_cts_data.index[0])
print(sig_cts_data.index[-1])
sig_cts_diff = pd.DataFrame(sig_cts_data['Cts_diff'])

# Load ref counts
ref_cts_data = lif.load_counts(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACRUISE\C287_020522\processed data_050224_ref')
...
ax2 = ax.twinx()
ax2.plot(ref_cts_diff.loc['2022-05-02 11:07:00':], color='green', alpha=0.6)
ax2.set_ylabel('Ref cell difference (cps/mW)', fontsize=18)

ax2.errorbar(x=sens_ref_ratio['Average Time'], y=sens_ref_ratio['Sensitivity'], yerr=sens_ref_ratio['Sensitivity Error'],
            color='limegreen', marker='o', ms=8, ls='')
ax2.set_ylabel('Sensitivity (sig diff / ref diff)', color='limegreen', fontsize=18)
ax2.axes.tick_params(axis='both', labelsize=16)


# Read in FAAM altitude and SO2 data
FAAM_data = Dataset(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACRUISE\FAAM_data\core_faam_20220502_v005_r2_c287_1hz.nc', format='NETCDF4_CLASSIC')
...
FAAM_SO2_mr_1hz = TECO_df.loc['2022-05-02 11:28:00':'2022-05-02 16:20:00']
#FAAM_SO2_mr_1hz = FAAM_SO2_mr_1hz.interpolate(method='linear')
#FAAM_SO2_mr_1hz.to_csv('Final_FAAM_SO2_mr_1Hz_C287_interp.csv')
...
#SO2_mr.to_excel('SO2_mr_10hz_C287_with_cals.xlsx')
...
SO2_mr_4hz = SO2_mr_4hz.loc['2022-05-02 11:28:00':'2022-05-02 16:20:00']
...
SO2_mr_5hz = SO2_mr_5hz.loc['2022-05-02 11:28:00':'2022-05-02 16:20:00']
#SO2_mr_5hz = SO2_mr_5hz.interpolate(method='linear')
#SO2_mr_5hz.to_csv('Final_LIF_SO2_mr_5Hz_C287.csv')

## average data to 1 s and save data
SO2_mr_1hz = SO2_mr_filt.resample('1s').aggregate(lambda x: pd.DataFrame.mean(x, skipna=False))
SO2_mr_1hz = SO2_mr_1hz.loc['2022-05-02 11:28:00':'2022-05-02 16:20:00']
#SO2_mr_1hz.to_csv('Final_LIF_SO2_mr_1Hz_C287.csv')
...
SO2_mr_10s = SO2_mr_10s.loc['2022-05-02 11:28:00':'2022-05-02 16:20:00']
#SO2_mr_10s.to_csv('Final_LIF_SO2_mr_10s_C287.csv')
...
CIMS_SO2_mr_4hz = CIMS_SO2_mr.loc['2022-05-02 11:28:00':'2022-05-02 16:20:00']
CIMS_SO2_mr_4hz = CIMS_SO2_mr_4hz / 11.966

# Load CO2 data
CO2_data = pd.read_csv(r"C:\Users\lgt505\Google Drive\Flight Campaigns\ACRUISE\C287_020522\CO2_data\faam-fgga_faam_20220502_r0_c287.na", header=54, sep=' ',
                       names=['Date_time', 'CO2_ppm', 'CO2_flag', 'Methane_ppb', 'Methane_flag', 'flow_status'])
Ref_date = pd.to_datetime('2022-05-02 00:00:00').tz_localize(None)
...
CO2_data = CO2_data.loc['2022-05-02 11:28:00':'2022-05-02 16:20:00']
...
#CO2_data.to_csv('CO2_mr_10Hz_C287_interp.csv')


###############################################################################
# Plume analysis - to be imported into script 'Plume_int_C287' for integration
...
#CIMS_SO2_mr_4hz.index = CIMS_SO2_mr_4hz.index - pd.Timedelta(seconds=0.2)
CIMS_SO2_mr_4hz.index = CIMS_SO2_mr_4hz.index - pd.Timedelta(seconds=1.2)
CO2_data_4hz.index = CO2_data_4hz.index + pd.Timedelta(seconds=2.9)
...
CO2_data_Picarro = CO2_data_4hz.loc['2022-05-02 15:17:10':'2022-05-02 15:19:24']
SO2_data_CIMS = CIMS_SO2_mr_4hz.loc['2022-05-02 15:17:10':'2022-05-02 15:19:24']
SO2_data_LIF = SO2_mr_4hz.loc['2022-05-02 15:17:10':'2022-05-02 15:19:24']
SO2_data_PF = FAAM_SO2_mr_1hz.loc['2022-05-02 15:17:10':'2022-05-02 15:19:24']
...
#CO2_data_Picarro.to_csv('C287_CO2_tm_int_4hz.csv')
#SO2_data_CIMS.to_csv('C287_SO2_CIMS_tm_int_4hz_cps.csv')
#SO2_data_LIF.to_csv('C287_SO2_LIF_tm_int_4hz.csv')
#SO2_data_PF.to_csv('C287_SO2_PF_tm_int_1s.csv')
...
CO2_data_Picarro = CO2_data_4hz.loc['2022-05-02 15:20:07':'2022-05-02 15:24:07']
SO2_data_CIMS = CIMS_SO2_mr_4hz.loc['2022-05-02 15:20:07':'2022-05-02 15:24:07']
SO2_data_LIF = SO2_mr_4hz.loc['2022-05-02 15:20:07':'2022-05-02 15:24:07']
SO2_data_PF = FAAM_SO2_mr_1hz.loc['2022-05-02 15:20:07':'2022-05-02 15:24:07']
...
#CO2_data_Picarro.to_csv('C287_CO2_tm_int_4hz_2.csv')
#SO2_data_CIMS.to_csv('C287_SO2_CIMS_tm_int_4hz_2_cps.csv')
#SO2_data_LIF.to_csv('C287_SO2_LIF_tm_int_4hz_2.csv')
#SO2_data_PF.to_csv('C287_SO2_PF_tm_int_1s_2.csv')
...
#plt.plot(Time_correct, (np.array(CIMS_mr_time_correct)-0.57222)/0.36998, color='green', alpha=0.7)
...
#CIMS_SO2_mr_10s_tm.to_excel('Final_CIMS_SO2_mr_10s_tm.xlsx')
