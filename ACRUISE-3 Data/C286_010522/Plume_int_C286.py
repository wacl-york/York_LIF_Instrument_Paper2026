...
CO2_int = pd.read_csv(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACRUISE\C286_010522\C286_CO2_tm_int_4hz.csv')
CO2_int.index = pd.to_datetime(CO2_int['Date_time'])

SO2_int_LIF = pd.read_csv(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACRUISE\C286_010522\C286_SO2_LIF_tm_int_4hz.csv')
SO2_int_LIF.index = pd.to_datetime(SO2_int_LIF['Date_time'])

#SO2_int_CIMS = pd.read_csv(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACRUISE\C286_010522\C286_SO2_CIMS_tm_int_4hz.csv')
SO2_int_CIMS = pd.read_csv(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACRUISE\C286_010522\C286_SO2_CIMS_tm_int_4hz_cps.csv')
SO2_int_CIMS.index = pd.to_datetime(SO2_int_CIMS['Date_time'])

SO2_int_PF = pd.read_csv(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACRUISE\C286_010522\C286_SO2_PF_tm_int_1s.csv')
...
CO2_bkd.loc['2022-05-01 14:46:12':'2022-05-01 14:46:18'] = np.nan
...
CO2_remove_loc = CO2_remove['CO2_ppm'].loc['2022-05-01 14:46:12':'2022-05-01 14:46:18']
...
SO2_bkd_LIF.loc['2022-05-01 14:46:12':'2022-05-01 14:46:19'] = np.nan
...
SO2_remove_LIF_loc = SO2_remove_LIF['SO2_ppb'].loc['2022-05-01 14:46:12':'2022-05-01 14:46:19']
...
SO2_bkd_CIMS.loc['2022-05-01 14:46:12':'2022-05-01 14:46:19'] = np.nan
...
SO2_remove_CIMS_loc = SO2_remove_CIMS['SO2_ppb'].loc['2022-05-01 14:46:12':'2022-05-01 14:46:19']
...
SO2_remove_PF = pd.DataFrame({'SO2_ppb': SO2_int_PF['SO2_ppb'] - SO2_bkd_PF['sma']})
plt.plot(SO2_remove_PF)
...
################### Regression
#SO2_remove_CIMS = (areas_SO2_LIF / areas_SO2_CIMS) * SO2_remove_CIMS.loc['2022-05-01 14:46:12':'2022-05-01 14:46:18']
SO2_remove_CIMS = SO2_remove_CIMS.loc['2022-05-01 14:46:12':'2022-05-01 14:46:18']
CO2_remove = CO2_remove.loc['2022-05-01 14:46:12':'2022-05-01 14:46:18']
SO2_remove_LIF = SO2_remove_LIF.loc['2022-05-01 14:46:12':'2022-05-01 14:46:18']
