...
#reprocess_binary_data(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\c292_070522\LIFCnts_20220507', 
                      #'07/05/2022 10:58:59', skip_start=1, n_bad_online=1)
...
# Load signal counts
sig_cts_data = lif.load_counts(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\c292_070522\processed data_030723_sig')
...
# Load ref counts
ref_cts_data = lif.load_counts(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\c292_070522\processed data_030723_ref')
...
FAAM_data = Dataset(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\FAAM_data\core_faam_20220507_v005_r2_c292_1hz.nc', format='NETCDF4_CLASSIC')
...
FAAM_SO2_mr_1hz = TECO_df.loc['2022-05-07 12:19:30':'2022-05-07 16:45:00']
...
SO2_mr_filt = SO2_mr.loc['2022-05-07 12:19:30':'2022-05-07 16:45:00']
...
SO2_mr_10s.to_csv('York_LIF_SO2_10s_C292.csv')
