...
#reprocess_binary_data(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\c290_050522\LIFCnts_20220505', 
                      #'05/05/2022 09:00:32', skip_start=1, n_bad_online=1)
...
# Load signal counts
sig_cts_data = lif.load_counts(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\c290_050522\processed data_030723_sig')
...
# Load ref counts
ref_cts_data = lif.load_counts(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\c290_050522\processed data_030723_ref')
...
fig, ax = plt.subplots()
ax.errorbar(x=sens_amb['Average Time'][1:], y=sens_amb['Sensitivity'][1:], yerr=sens_amb['Sensitivity Error'][1:], 
...
FAAM_data = Dataset(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\FAAM_data\core_faam_20220505_v005_r2_c290_1hz.nc', format='NETCDF4_CLASSIC')
...
FAAM_SO2_mr_1hz = TECO_df.loc['2022-05-05 12:45:00':'2022-05-05 16:58:00']
...
SO2_mr_filt = SO2_mr.loc['2022-05-05 12:45:00':'2022-05-05 16:58:00']
...
SO2_mr_10s.to_csv('York_LIF_SO2_10s_C290.csv')
