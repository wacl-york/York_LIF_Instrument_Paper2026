...
#reprocess_binary_data(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\c293_080522\LIFCnts_20220508', 
                      #'08/05/2022 11:23:45', skip_start=1, n_bad_online=1)
...
# Load signal counts
sig_cts_data = lif.load_counts(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\c293_080522\processed data_030723_sig')
...
# Load ref counts
ref_cts_data = lif.load_counts(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\c293_080522\processed data_030723_ref')
...
FAAM_data = Dataset(r'C:\Users\lgt505\Google Drive\Flight Campaigns\ACSIS\FAAM_data\core_faam_20220508_v005_r2_c293_1hz.nc', format='NETCDF4_CLASSIC')
...
FAAM_SO2_mr_1hz = TECO_df.loc['2022-05-08 12:19:30':'2022-05-08 16:50:00']
...
SO2_mr_filt = SO2_mr.loc['2022-05-08 12:19:30':'2022-05-08 16:50:00']
...
SO2_mr_10s.to_csv('York_LIF_SO2_10s_C293.csv')
